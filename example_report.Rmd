...
De 2015 a 2022 se han registrado **`r comma(vio_total)`** carpetas de **`r Delito_Ficha_2`** en el municipio, el año con mayor registros es el **`r vio_año`** con **`r comma(vio_max)`**. De enero a septiembre 2022 se han contabilizado **`r comma(vio_2022)`** carpetas.
...
Total de ordenes de protección (2019 a 2022 septiembre) por municipio:
...
Total de medidas de protección (2019 a 2022 septiembre) por municipio:
